...
/**
 * Repeats a promise-returning operation a set number of times. Firebase will put a temorary
    ...
    return new Promise((resolve, reject) => {
        Users.root.orderByChild('testuser').equalTo(true).once("value", snapshot => {
            ...
            let deleteUser = function() {
                let id = ids.shift();
                return Users.root.removeUser({email: list[id].email, password: 'testuser'})
                    .then(ok => {
